BulletFinder
README
Fully functioning standing alone program (once exported to a runnable .jar file). BulletFinder is a projectile calculator that does not take into account drag. The information required in the program can usually be found on the ammo box. It is accurate out to about ~200 yrds.
